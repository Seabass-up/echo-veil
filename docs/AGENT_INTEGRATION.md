...
An optional `supporting` mode uses explicit `0.25` broad-relevance and
answerability floors, then ranks with a bounded 65/35
broad-relevance/answerability blend. It is
